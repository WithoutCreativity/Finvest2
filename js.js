// JavaScript to reorder divs in desktop view
...
// Function to get orientation and reload functions accordingly
...
window.addEventListener('orientationchange', (ev) => {
    ...
    console.log('Orientation changed:', orn);
    console.dir(ev);
});
